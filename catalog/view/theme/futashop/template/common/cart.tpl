      ...
      <table class="table table-striped">
        ...
        <tr>
          <td class="text-center"><?php if ($product['thumb']) { ?>
            <a href="<?php echo $product['../../../default - Copy/template/common/href']; ?>"><img src="<?php echo $product['../../../default - Copy/template/common/thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-thumbnail" /></a>
            <?php } ?></td>
          <td class="text-left"><a href="<?php echo $product['../../../default - Copy/template/common/href']; ?>"><?php echo $product['name']; ?></a>
