...
<div class="container">
  <ul class="breadcrumb">
    ...
    <li><a href="<?php echo $breadcrumb['../../../../default - Copy/template/extension/credit_card/href']; ?>"><?php echo $breadcrumb['text']; ?></a></li>
    <?php } ?>
  </ul>
  <?php if ($success) { ?>
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td class="text-right"><a href="<?php echo $delete . $card['../../../../default - Copy/template/extension/credit_card/card_id']; ?>" class="btn btn-danger"><?php echo $button_delete; ?></a></td>
