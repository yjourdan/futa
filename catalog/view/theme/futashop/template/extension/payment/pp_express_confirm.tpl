...
<div class="container">
  <ul class="breadcrumb">
    ...
    <li><a href="<?php echo $breadcrumb['../../../../default - Copy/template/extension/payment/href']; ?>"><?php echo $breadcrumb['text']; ?></a></li>
    <?php } ?>
  </ul>
  <?php if ($attention) { ?>
      ...
      <div class="table-responsive">
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              <td class="text-left"><a href="<?php echo $product['../../../../default - Copy/template/extension/payment/href']; ?>"><?php echo $product['name']; ?></a>
